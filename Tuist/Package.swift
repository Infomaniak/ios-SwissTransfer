...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Infomaniak/multiplatform-SwissTransfer", .upToNextMajor(from: "2.0.0")),
        ...
        .package(url: "https://github.com/Infomaniak/ios-version-checker", .upToNextMajor(from: "10.1.0"))
    ]
)
